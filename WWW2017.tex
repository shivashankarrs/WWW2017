...
\author[2*]{\Large{Tim Baldwin}}
\author[3*]{\Large{Julian Brooke}}
\author[4*]{\Large{Trevor Cohn}\vspace{-0.3cm}}
\affil[*]{\large Department of CIS, \   The University of Melbourne, \   VIC, Australia}
\affil[1]{\small \url{shivashankar@student.unimelb.edu.au}} 
